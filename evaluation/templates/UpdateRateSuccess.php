...
<?php } ?>
    ...
    addtoGridLoad();
            ...
            location.href="<?php echo url_for('evaluation/UpdateRate?id=' . $encrypt->encrypt($Rate->rate_id) . '&lock=1') ?>";
                           }
                           else {
                               for(var k=0; k<=i; k++){
                       ...
                       $("#btnClear").click(function() {
                           ...
                           location.href="<?php echo url_for('evaluation/UpdateRate?id=' . $encrypt->encrypt($Rate->rate_id) . '&lock=0') ?>";
                       });
                   });
</script>
