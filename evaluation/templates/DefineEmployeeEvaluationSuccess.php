                ...
                <tbody>
                    ...
                    ?>
                                <tr class="<?php echo $cssClass ?>">
                                    ...
                                    <td class="">
                                        <a href="<?php echo url_for('evaluation/UpdateEmployeeEvaluation?id=' . $encrypt->encrypt($EvaluationEmployee->ev_id)) ?>"><?php
                                if ($Culture == 'en') {
                    ...
                    ?></a>
                        ...
                        <a href="<?php echo url_for('evaluation/EmployeeEvaluation?id=' . $encrypt->encrypt($EvaluationEmployee->ev_id).'&type=2') ?>"><?php
                                ...
                                ?> </a> <?php  } else {?>
                        <a href="<?php echo url_for('evaluation/EmployeeEvaluation?id=' . $encrypt->encrypt($EvaluationEmployee->ev_id).'&type='.$type) ?>"><?php
                                if ($Culture == 'en') {
                                    echo "Evaluate";
                                } 
                                ?> </a>
